(() => {
  ...
  function processWordsString(wordsString) {
    // a function that takes a string representing the 
    // raw text of the words which is then split into a list of 
    // words and then sorted based on the length of the word 
    // and then split into three groups each for a difficulty value
    let words = wordsString.split(", ").sort((a, b) => {
  ...
  let words = processWordsString(wordsString);
